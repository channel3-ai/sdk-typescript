import fs from 'fs';
import type { ResponseLike } from '@channel3/sdk/internal/to-file';
import { toFile } from '@channel3/sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@channel3/sdk/core/uploads');
    await expect(
