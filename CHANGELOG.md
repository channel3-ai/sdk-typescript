...
* add channel3 cli to stainless... i think? ([9d5d49e](https://github.com/channel3-ai/sdk-typescript/commit/9d5d49e25f1344576829e3e8fd35ac184fefdfeb))
* Add SDK client-level locale ([24f8851](https://github.com/channel3-ai/sdk-typescript/commit/24f8851cbd010ef4de2e92d14c95043244c2bde1))
...
* **api:** add categories, products/brands search, deprecate search/enrich, brands to v1 ([5679c2d](https://github.com/channel3-ai/sdk-typescript/commit/5679c2d545ce588107ee44c6cc2e65069abfee70))
* **api:** add category field, deprecate categories in enrich/products responses ([f09345e](https://github.com/channel3-ai/sdk-typescript/commit/f09345edf78b5207e67de9a1ca970dbcb3b2d9aa))
* **api:** add cleaned_url field to enrich and products image types ([ad96be9](https://github.com/channel3-ai/sdk-typescript/commit/ad96be9da9c27ef6213a777b9a3abc54ff83d065))
* **api:** add clicks and transactions resources ([d10fc3d](https://github.com/channel3-ai/sdk-typescript/commit/d10fc3d4d49eeb3e37647bda2af1256ac0587c05))
* **api:** add country/currency/language parameters to products/search ([17f950b](https://github.com/channel3-ai/sdk-typescript/commit/17f950b98005401e68f63c44777a8cddeb867ce4))
* **api:** add lengthUnit/weightUnit client config, rename unit params in products/search ([a603eeb](https://github.com/channel3-ai/sdk-typescript/commit/a603eebabbf1f80591388a1391b8d081c4e787a6))
* **api:** add mode parameter to search, deprecate keyword_search_only ([2001f51](https://github.com/channel3-ai/sdk-typescript/commit/2001f511d84eab6961267f70fbfe69f93767f103))
...
* **api:** add variants field to products, update structure in enrich ([6ad732e](https://github.com/channel3-ai/sdk-typescript/commit/6ad732effde26c856bf159a5cccdbe1babd6b867))
...
* Experimental ClickHouse scraping telemetry (+ Grafana dashboards) ([7185c4e](https://github.com/channel3-ai/sdk-typescript/commit/7185c4e76b012df5b397d4a8f06ffef8a11302cb))
* Extracted attribute search on the API (test) ([1aebaac](https://github.com/channel3-ai/sdk-typescript/commit/1aebaac04f39a2fd415ca68bc6062a59b8b0af92))
* fix/trigger workflow ([a857107](https://github.com/channel3-ai/sdk-typescript/commit/a857107631a02d1bb518fd758762243178568a40))
* Image search endpoint ([1877623](https://github.com/channel3-ai/sdk-typescript/commit/18776231dda86307d183194c405ab8e6d97feb8e))
* Index offer dimensions into OpenSearch and expose dimension search filters ([a36c66a](https://github.com/channel3-ai/sdk-typescript/commit/a36c66a16910a0e9368d20ae40c4b5507d3c6c89))
...
* **stlc:** configurable CI runner and private-production-repo support in workflow templates ([78942f8](https://github.com/channel3-ai/sdk-typescript/commit/78942f86b00101a4908da161d8e686bb4fcd5f7c))
* support setting headers via env ([9365206](https://github.com/channel3-ai/sdk-typescript/commit/93652064a518908278f50d1f8910ce8bb87af768))
...
* **client:** emit method aliases after the methods they reference ([78191ed](https://github.com/channel3-ai/sdk-typescript/commit/78191edf2a79da220939d4f76544babf3fe8d45b))
...
* **client:** send content-type header for requests with an omitted optional body ([6188a74](https://github.com/channel3-ai/sdk-typescript/commit/6188a746fa8562789d1a0356bbbbb9605efb2089))
...
* **typescript:** upgrade tsc-multi so that it works with Node 26 ([d8eebc1](https://github.com/channel3-ai/sdk-typescript/commit/d8eebc18c2de9709d588d520f277bb8001f23b6b))
* **types:** remove MIN_PRICE_FLOOR field from SearchFilterPrice ([6d86986](https://github.com/channel3-ai/sdk-typescript/commit/6d86986c4a2eb63a2c17b8226635e327ad7fbd50))
* **types:** remove unisex option from gender field in SearchFilters ([8c8d9d9](https://github.com/channel3-ai/sdk-typescript/commit/8c8d9d9056da236bc33e653ffedf2be15f8b3dd0))
...
* **format:** run eslint and prettier separately ([ec3c0b5](https://github.com/channel3-ai/sdk-typescript/commit/ec3c0b5b91f0ad8a2bd0435ee31302f7b2199220))
...
* **internal:** codegen related update ([63384da](https://github.com/channel3-ai/sdk-typescript/commit/63384dac8b7a4e4bfb29865c86cb4e3aeac50b9d))
* **internal:** codegen related update ([f2ef04c](https://github.com/channel3-ai/sdk-typescript/commit/f2ef04ca5c70e269ba95308aff3a522cc97bf8ef))
...
* **internal:** more robust bootstrap script ([afb10aa](https://github.com/channel3-ai/sdk-typescript/commit/afb10aa8b1c8f1a7addb41438e655979a712ec01))
...
* **internal:** regenerate SDK with no functional changes ([8a7cf35](https://github.com/channel3-ai/sdk-typescript/commit/8a7cf353d26d88ba1a11c0c754c7c9efb2eb32d7))
* **internal:** regenerate SDK with no functional changes ([8e54582](https://github.com/channel3-ai/sdk-typescript/commit/8e5458233cc1123ae637ebe002b566d74a11877a))
* **internal:** regenerate SDK with no functional changes ([6f8068b](https://github.com/channel3-ai/sdk-typescript/commit/6f8068b0d831bc454c5158c90c8ecea850968a04))
* **internal:** regenerate SDK with no functional changes ([363b5ea](https://github.com/channel3-ai/sdk-typescript/commit/363b5ea4afc60ede3f08a1bdc4f4f98bb5e1f888))
...
* onboard Renovate ([#31](https://github.com/channel3-ai/sdk-typescript/issues/31)) ([4124ca3](https://github.com/channel3-ai/sdk-typescript/commit/4124ca3963f84b993bad9595f332423ff089d8e2))
* redact api-key headers in debug logs ([c075175](https://github.com/channel3-ai/sdk-typescript/commit/c075175c9d96e8c17ae9015b64bdf037e4513039))
* sync repo ([22dfc31](https://github.com/channel3-ai/sdk-typescript/commit/22dfc314c1e4a18dfc4e15d24568e6d41ec884c7))
* **tests:** remove redundant File import ([67d6dad](https://github.com/channel3-ai/sdk-typescript/commit/67d6dad569a385b31fee67a253b862f338638ea0))
* **types:** deprecate is_cleaned_image field in ProductImage model ([2845134](https://github.com/channel3-ai/sdk-typescript/commit/284513450b874c98c03beab22b858738982cc1a2))
...
* **api:** clarify category_ids and exclude_category_ids accept slugs in search ([c1bf495](https://github.com/channel3-ai/sdk-typescript/commit/c1bf4953f258fbeaf0cc139bb3f454971430e22f))
* **api:** clarify page_token parameter in products and search methods ([d4dbd05](https://github.com/channel3-ai/sdk-typescript/commit/d4dbd05a9a4279cd3a5a5163a690966333aa40a0))
* **api:** clarify search parameter requirements ([3a969e6](https://github.com/channel3-ai/sdk-typescript/commit/3a969e645e515b8de83d2d83a656c7c2a7701816))
* **api:** improve is_cleaned_image description in enrich/products ([0686b7c](https://github.com/channel3-ai/sdk-typescript/commit/0686b7c4ac6d32c1ac90d8a96e7b185f513839b2))
* **types:** clarify max_commission_rate format in ProductOffer ([c172fee](https://github.com/channel3-ai/sdk-typescript/commit/c172fee09d7bd63a68a63e0d059e11545d69796f))
